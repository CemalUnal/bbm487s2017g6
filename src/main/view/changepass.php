...
//echo $row["username"]; ?>
               ...
               <div style="margin-left: 0px; margin-top: 20px;">
                 <label>Eski Şifre  :</label><input type = "password" name = "oldpassword" class = "box" /><br/><br />
                  </div>
                   <div style="margin-left: -1px;">
                  <label>Yeni Şifre  :</label><input type = "password" name = "newpassword" class = "box" /><br/><br />
                 </div>
                  <div style="margin-left: -125px;">
                  <label>Yeni Şifrenizi Tekrar Giriniz  :</label><input type = "password" name = "new2password" class = "box" /><br/><br />
                  </div>
                              ...
                              <?php
              echo '<a href="userinfo.php" class="button button0">İPTAL</a>';
                ?>

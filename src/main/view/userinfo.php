...
//echo $row["username"]; ?>
<div class="fonts">
               <form action = "../Controller/changeuser.php" method = "post">
               <div style="margin-left: 0px; margin-top: 20px;">
                  ...
                  <label>E-Mail  :</label><input type = "text" name = "email" value="<?php echo $row["email"]; ?>" class = "box" /><br/><br />
                              ...
                              <?php
              echo '<a href="changepass.php"  class="button button0">ŞİFREMİ DEĞİŞTİRMEK İSTİYORUM </a>';
                ?>
                
                <!--  <div style="margin-left: 20px; margin-bottom: 100px;">-->

                  <input type = "submit" class="button button0" value = "BİLGİLERİMİ DEĞİŞTİR "/><br />
                  </div>
               </form>
</div></div>
<div id="footer"></div>

...
<div class="fonts">
               ...
               <div style="margin-left: -30px; margin-top: 20px;">
                  <label>Kitabın Adı :</label><input type = "text" name = "name" value="<?php echo $row["name"]; ?>" class = "box" /><br /><br />
                  </div>
                   <div style="margin-left: 0px;">
                  <label>Yazarı :</label><input type = "text" name = "surname" value="<?php echo $row["author"]; ?>" class = "box" /><br /><br />
                 </div>
                  <div style="margin-left: -30px;">
                  <label>Basım Yılı  :</label><input type = "text" name = "email" value="<?php echo $row["year"]; ?>" class = "box" /><br/><br />
                  </div>
                  <div style="margin-left: -80px;">
                  <label>Uygunluk Durumu  :</label><input type = "text" name = "email" value="<?php if ($row["available"]==0) echo "Uygun"; else echo "Uygun Değil";  ?>" class = "box" /><br/><br />
                  </div>
              </div>    
                                ...
                                <?php
echo '<a href="deleteuser.php?bookId='. $bookId .'"  class="button button0">KİTABI SİL</a>';
                ?>
